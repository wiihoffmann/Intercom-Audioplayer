...
public:
    ...
    void setupUi(QDialog *Settings)
    {
        ...
        gridLayout->addItem(verticalSpacer_4, 16, 0, 1, 1);

        Volume_Label = new QLabel(Settings);
        Volume_Label->setObjectName(QStringLiteral("Volume_Label"));

        gridLayout->addWidget(Volume_Label, 11, 0, 1, 1);
        ...
        gridLayout->addWidget(Volume_Slider, 12, 0, 1, 1);
        ...
        gridLayout->addWidget(Repeat_Checkbox, 9, 0, 1, 1);
        ...
        Random_Checkbox->setEnabled(false);
        ...
        gridLayout->addWidget(fade_Slider, 14, 0, 1, 1);

        fade_Label = new QLabel(Settings);
        fade_Label->setObjectName(QStringLiteral("fade_Label"));

        gridLayout->addWidget(fade_Label, 13, 0, 1, 1);
