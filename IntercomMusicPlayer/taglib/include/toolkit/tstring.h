...
namespace TagLib {
  ...
  //! A \e wide string class _TagLibExport suitable for unicode.
 ...
 * \relates TagLib::String
 */
const TagLib::String _TagLibExport operator+(const TagLib::String &s1, const TagLib::String &s2);

/*!
 * \relates TagLib::String
 */
const TagLib::String _TagLibExport operator+(const char *s1, const TagLib::String &s2);

/*!
 * \relates TagLib::String
 */
const TagLib::String _TagLibExport operator+(const TagLib::String &s1, const char *s2);
 ...
 */
std::ostream _TagLibExport &operator<<(std::ostream &s, const TagLib::String &str);
