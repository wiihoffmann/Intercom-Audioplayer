...
namespace TagLib {
  ...
  /*!
   * This class  is a basic file class _TagLibExport with some methods that are particularly
  ...
  protected:
     ...
     *
     * \note Constructor is protected since this class _TagLibExport should only be
